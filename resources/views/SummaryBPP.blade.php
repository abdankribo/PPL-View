...
<body>
        ...
        <div class="pt-[70px] h-full flex flex-col justify-between">
            ...
            <div>
                <ul>
                    ...
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
                        <a href="SummaryBPP" class="text-red-600">Manajemen Summary BPP></a>
                    </li>
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
    ...
    <section>
        ...
        <h1>Business Process Perspective Summary</h1>

        <section>
            <h2>Process Overview</h2>
            <p>Brief description of the primary business processes within the organization.</p>
        </section>
    
        <section>
            <h2>Key Performance Indicators (KPIs)</h2>
            <p>Highlight essential metrics and KPIs for assessing process effectiveness and efficiency.</p>
        </section>
    
        <section>
            <h2>Goals and Objectives</h2>
            <p>Outline goals and objectives associated with business processes, such as efficiency improvements and cost reductions.</p>
        </section>
    </section>
