...
<body>
        ...
        <div class="pt-[70px] h-full flex flex-col justify-between">
            ...
            <div>
                <ul>
                    ...
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
                        <a href="/gudang-manajemen" class="text-red-600">Manajemen Gudang></a>
                    </li>
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
    ...
    <section class="ml-[400px] mr-[60px] py-1 mt-20">
        ...
        <div class="bg-[#D9D9D9] w-full py-7 mb-12 xl:mb-0 px-7 mx-auto">
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-blueGray-700">Tabel Manajemen Gudang</h3>
                        </div>
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                            <a href="/tambah/gudang-manajemen"
                                class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button">Tambah Gudang</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    ...
                                    <a href="edit/gudang-manajemen" class="bg-green-500 text-white px-3 py-2 rounded">Edit</a>
                                    <a href="" class="bg-red-500 text-white px-3 py-2 rounded">Delete</a>
                                </td>
        ...
        <div class="bg-[#D9D9D9] w-full py-7 mb-12 xl:mb-0 px-7 mx-auto">
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-blueGray-700">Tabel Manajemen Gudang  Virtual</h3>
                        </div>
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                            <a href="/tambah/virtual-gudang-manajemen"
                                class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button">Tambah Gudang  Virtual</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <a href="edit/virtual-gudang-manajemen" class="bg-green-500 text-white px-3 py-2 rounded">Edit</a>
                                    <a href="" class="bg-red-500 text-white px-3 py-2 rounded">Delete</a>
                                </td>
        ...
        <div class="bg-[#D9D9D9] w-full py-7 mb-12 xl:mb-0 px-7 mx-auto">
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-blueGray-700">Transfer Item</h3>
                        </div>
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                            <a href="/tambah/item-transfer-manajemen"
                                class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button">Transfer Item</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <a href="edit/item-transfer-manajemen" class="bg-green-500 text-white px-3 py-2 rounded">Edit</a>
                                    <a href="" class="bg-green-500 text-white px-3 py-2 rounded">Selesai</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <a href="edit/item-transfer-manajemen" class="bg-green-500 text-white px-3 py-2 rounded">Edit</a>
                                    <a href="" class="bg-red-500 text-white px-3 py-2 rounded">Batal</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <a href="edit/item-transfer-manajemen" class="bg-green-500 text-white px-3 py-2 rounded">Edit</a>
                                    <a href="" class="bg-yellow-500 text-white px-3 py-2 rounded">Proses</a>
                                </td>
