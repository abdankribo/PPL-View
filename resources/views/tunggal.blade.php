...
<body>
        ...
        <div class="pt-[70px] h-full flex flex-col justify-between">
            ...
            <div>
                <ul>
                    ...
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
                        <a href="tunggal" class="text-red-600">Manajemen Tanggal></a>
                    </li>
                </ul>
            </div>
    ...
    <section class="ml-[343px] mt-[54px]">
        <div class="container mx-auto p-4">

            <h1 class="text-2xl font-semibold text-gray-800 mb-4">Calendar View</h1>

            <table class="w-full border border-gray-300">
                <thead>
                    <tr>
                        <th class="py-2 px-4 border-b">Sun</th>
                        <th class="py-2 px-4 border-b">Mon</th>
                        <th class="py-2 px-4 border-b">Tue</th>
                        <th class="py-2 px-4 border-b">Wed</th>
                        <th class="py-2 px-4 border-b">Thu</th>
                        <th class="py-2 px-4 border-b">Fri</th>
                        <th class="py-2 px-4 border-b">Sat</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <!-- Continue adding rows for the rest of the month -->
                </tbody>
            </table>
