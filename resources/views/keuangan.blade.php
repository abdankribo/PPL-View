...
<body>
        ...
        <div class="pt-[70px] h-full flex flex-col justify-between">
            ...
            <div>
                <ul>
                    ...
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
                        <a href="keuangan"class="text-red-600">Manajemen Keuangan></a>
                    </li>
                    <li class="shadow bg-[#EDF2F7] py-2 my-4 font-semibold shadow-md shadow-gray-500 text-center">
    ...
    <section class="ml-[400px] mr-[60px] py-1 mt-20">
        ...
        <div class="container mx-auto my-8 p-8 bg-white rounded shadow-lg">
            <h1 class="text-4xl font-bold text-gray-800 mb-6">Money Management</h1>
        
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Transaction Card 1 -->
                <div class="bg-blue-100 p-6 rounded shadow-md">
                    <h2 class="text-xl font-semibold text-blue-800 mb-4">Transaction A</h2>
                    ...
                    <p class="mt-4 text-gray-600">Amount: $500</p>
                    <p class="text-gray-600">Date: January 1, 2023</p>
                </div>
        
                <!-- Transaction Card 2 -->
                <div class="bg-green-100 p-6 rounded shadow-md">
                    <h2 class="text-xl font-semibold text-green-800 mb-4">Transaction B</h2>
                    <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <p class="mt-4 text-gray-600">Amount: $800</p>
                    <p class="text-gray-600">Date: January 5, 2023</p>
                </div>
        
                <!-- Transaction Card 3 -->
                <div class="bg-orange-100 p-6 rounded shadow-md">
                    <h2 class="text-xl font-semibold text-orange-800 mb-4">Transaction C</h2>
                    <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <p class="mt-4 text-gray-600">Amount: $300</p>
                    <p class="text-gray-600">Date: January 10, 2023</p>
                </div>
            </div>
        
            <div class="mt-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">Account Summary</h2>
                <p class="text-gray-700">Total Balance: $1,600</p>
                <p class="text-gray-700">Income: $1,600</p>
                <p class="text-gray-700">Expenses: $0</p>
            </div>
        </div>
    </section>
